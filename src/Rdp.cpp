...
void loop_rdp()
{
  if(rdpenabled)
  {
    ...
    if (WiFiClient client = rdpServer.accept()) {
      ...
      handleBannerGrab(rdpHookweb,client, 3389, RDP_CC, sizeof(RDP_CC));
      logCommand(rdpHookweb, client.remoteIP().toString(), 3389, "RDP LOGIN","RDP"); 
    }
  }
}